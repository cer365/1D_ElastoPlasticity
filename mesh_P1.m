...
function [coord,elem,surf,neumann,Q]=mesh_P1(level,size_x)
...
%              size(elem)=(2,n_e), n_e = number of elements
...
%
  ...
  % used division of a rectangle into 1 line:   
  %   V1 V2        
  % the array elem, size(elem)=(2,n_e)          
  elem=[C(V1); C(V2)];     
